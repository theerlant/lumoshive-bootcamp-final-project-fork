...
import { Store, DollarSign, ShoppingBag, Coins, Twitter, Instagram, Linkedin,Truck,Headphones,ShieldCheck} from "lucide-react";
...
export default function AboutPage() {
  ...
  const stats = [
    { id: 1, icon: <Store size={30} />, value: "10.5k", label: "Sellers active our site" },
    { id: 2, icon: <DollarSign size={30} />, value: "33k", label: "Monthly Product Sale" },
    { id: 3, icon: <ShoppingBag size={30} />, value: "45.5k", label: "Customer active in our site" },
    { id: 4, icon: <Coins size={30} />, value: "25k", label: "Anual gross sale in our site" },
  ];

  const team = [
    { name: "Tom Cruise", role: "Founder & Chairman", image: image_founder },
    { name: "Emma Watson", role: "Managing Director", image: image_managing_director },
    { name: "Will Smith", role: "Product Designer", image: image_managing_designer },
  ];
  ...
  return (
    <div className="w-full">
      <div className="max-w-7xl mx-auto px-4 py-10 md:py-20">
        ...
        <nav className="flex mb-10 md:mb-20 text-sm">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-20 mb-24">
          <div className="w-full lg:w-1/2 space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold tracking-widest text-black">Our Story</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          {stats.map((stat) => (
            ...
            >
              ...
              <h2 className="text-3xl font-bold mt-4 group-hover:text-white">{stat.value}</h2>
              <p className="text-sm text-center mt-2 group-hover:text-white">{stat.label}</p>
            </div>
          ))}
        </div>
          ...
          {team.map((member, index) => (
            <div key={index} className="space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="text-2xl font-bold tracking-wider">{member.name}</h3>
