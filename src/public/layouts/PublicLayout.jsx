...
import { LucideSearch, LucideHeart, LucideShoppingCart, LucideUser } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen font-poppins">
      ...
      <div className="bg-black text-white py-3 text-center text-sm">
        <p>
          ...
          <Link to="/shop" className="font-bold underline ml-2">ShopNow</Link>
        </p>
      </div>
        ...
        <div className="container mx-auto px-4 flex items-center justify-between py-5">
          ...
          <div className="flex items-center gap-6">
            <div className="relative hidden lg:block">
              ...
              />
              <LucideSearch className="absolute right-3 top-2 text-gray-500" size={18} />
            </div>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-white flex items-center p-2 rounded">
              <input type="text" placeholder="Enter your email" className="bg-transparent text-sm outline-none w-full" />
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">Jl. Gatot Subroto, Jakarta, 12930, Indonesia.</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <div className="bg-gray-800 w-20 h-20 flex items-center justify-center rounded">QR</div>
