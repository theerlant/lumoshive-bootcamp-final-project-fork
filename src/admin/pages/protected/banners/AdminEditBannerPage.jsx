...
const AdminEditBannerPage = () => {
  ...
  useEffect(() => {
    ...
    const d = DUMMY_DATA.find((b) => b.id === id) || DUMMY_DATA[0];
    setFormData({
      name: d.name || "",
        ...
        >
          <div className="space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                className="border rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-red-500 outline-none"
                value={formData.name}
                onChange={(e) =>
            ...
            <div className="flex flex-col gap-2">
              ...
              <select
                className="border rounded-md px-3 py-2 text-sm bg-white focus:ring-1 focus:ring-red-500 outline-none"
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="border border-gray-200 rounded p-2 flex gap-4 items-center bg-gray-50">
                <img
                  src={preview}
                  className="w-20 h-12 object-cover rounded border bg-white"
                />
                <input
                  type="file"
                  className="text-xs"
      ...
      <Modal isOpen={showSuccessModal} onClose={() => {}}>
        <div className="flex flex-col items-center p-8 text-center">
          ...
          <h2 className="text-xl font-bold">
            This banner was successfully updated
          </h2>
        </div>
      </Modal>
    </div>
